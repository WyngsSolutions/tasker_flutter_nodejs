...
class DiscussionModel{
  ...
  getConversationMessages(String chatRoomId) async{
    return FirebaseFirestore.instance.collection("DiscussionRoom").
  ...
  sendConversationMessage(String chatRoomId, Map<String, dynamic> messageMap) async{
    FirebaseFirestore.instance.collection("DiscussionRoom").
  ...
  Future deleteChatRoom(String chatRoomId) async {
    try {
      dynamic result = await FirebaseFirestore.instance.collection("DiscussionRoom").
